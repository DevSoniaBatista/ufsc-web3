...
;
const metadata = {
    title: "Explorando a Web3 do Zero — Web3 do Zero",
    description: "Apresentação introdutória sobre Web3: evolução da internet, blockchain, aplicações no mundo real e oportunidades."
};
